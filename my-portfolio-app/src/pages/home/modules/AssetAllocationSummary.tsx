...
const AssetAllocationSummary: React.FC<AssetAllocationSummaryProps> = ({ 
  ...
  return (
  <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 h-full flex flex-col max-h-[547px]">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="bg-slate-800/60 border border-white/20 text-white px-2 py-0.5 rounded-md text-xs w-28 leading-tight focus:outline-none focus:ring-1 focus:ring-emerald-500"
